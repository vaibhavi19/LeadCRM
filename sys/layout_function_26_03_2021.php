...
// $html .=  $query ;
    ...
    $html .= "<tr><td><b>WO Release Date  :</b></td><td>" . $workorder_release_date . "</td><td><b>WO Status   :</b></td><td>" . $workorder_status_desc . "</td></tr><tr><td><b>Advance Request No :</b></td><td colspan=3>" . $advance_request_no . "</td></tr>";
...
$acknowledged_on = isset($row->acknowledged_on) ? $row->acknowledged_on : "";
    ...
    $html .= "<tr><td><b>Status :  </b></td><td>" . $status_desc . "</td><td><b>Pending with :  </b></td><td>" . $pending_with . "</td></tr>";
